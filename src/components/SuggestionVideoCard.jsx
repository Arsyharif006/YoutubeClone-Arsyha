  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex mb-8">
        <div className="relative h-24 lg:h-20 xl:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] overflow-hidden xl:w-40 xl:min-w-[168px] rounded-lg bg-slate-800">
          <img className="w-full h-full object-cover" src={video?.thumbnails?.[0]?.url} />
          {video?.lengthSeconds && (
